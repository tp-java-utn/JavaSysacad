...
public class MainPageAdmAlumno extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("Eliminar"))
		{
			...
			DA.delete(legajo);
			request.getRequestDispatcher("/MainPageAdmAlumno.jsp").forward(request, response);
		}
		...
		else if(action.equalsIgnoreCase("Editar"))
		{
			...
			request.getRequestDispatcher("/MainPageAdmAlumnoEdit.jsp").forward(request, response);
		}
	}
