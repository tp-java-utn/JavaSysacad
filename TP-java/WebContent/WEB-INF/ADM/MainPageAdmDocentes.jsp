		  	...
		  	<div class="container-fluid">			  
				...
				<div class="jumbotron" style="padding-bottom: 15px;padding-top: 15px;">
					<div class="row">
						...
						<div class="col">
							<a href="#" type="button" class="btn btn-success" style="float:right;margin-top: 11px;"><i class="fas fa-user-plus"></i> Nuevo Docente</a>
						</div>
					</div>
						  	...
						  	<% for (Docente D:Docentes) {%>
						  		...
						  		<tr>
								    ...
								    <td align="center" style="padding-left: 10%;">					
								    	...
								    	<a href="#" type="button" class="btn btn-warning"><i class="fas fa-user-edit"></i> Editar</a>
