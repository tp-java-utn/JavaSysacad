			...
			<div class="container marketing" style="text-align: center;">
			    ...
			    <div class="row">
			      ...
			      <div class="col-lg-4">
			        ...
			        <p>Aqui podras ver tu estado academico, es el espacio donde se subiran las notas de los 
				...
				<%for(Examen E:Examenes){%>
					...
					<div class="my-3 p-3 bg-white rounded shadow-sm">
					    ...
					    <div class="media text-muted pt-3">
					    	<%if(E.getNota()>=6){%>
					    	<svg class="bd-placeholder-img mr-2 rounded" width="32" height="32" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 32x32"><title>Placeholder</title><rect width="100%" height="100%" fill="#5cb85c"></rect></svg>
						    <%}else{%>
						    ...
						    <div class="media-body pb-3 mb-0 small lh-125 border-bottom border-gray">				  	
								<div class="d-flex justify-content-between align-items-center w-100">
								    	<strong class="text-gray-dark">Examen <%=E.getTipo()%> <%=E.getIdExamen()%> - <%=E.getFecha()%></strong>						    
								</div>
